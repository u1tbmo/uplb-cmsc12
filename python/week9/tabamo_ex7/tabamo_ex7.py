...
def program(s_dict, hist) -> None:
    """The main program loop.
    """
    while True:
        # Remove stock prices for stocks with 0 quantity
        s_dict = clean_dict(s_dict)
        ...
        if c == "1":
            ...
            viewPortfolio(s_dict)
        elif c == "2":
            s_dict = buyStock(s_dict)
        elif c == "3":
            s_dict = sellStock(s_dict)
        elif c == "4":
